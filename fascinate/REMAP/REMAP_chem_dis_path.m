...
outfile='C:\Users\Hansaim\Documents\GitHub\wiZAN\fascinate\REMAP\dis_sim\TPR20_path.txt'
input_dir='C:\Users\Hansaim\Documents\GitHub\wiZAN\fascinate\data\chem_dis\10fold\'
chem_chem_mat=chem_chem_sim;
prot_prot_mat=dis_dis_sim_path_norm;
...
fid=fopen(outfile,'a+');
fprintf(fid,['rank=' num2str(rank) ' iter=' num2str(iter) ' dis_sim=path_normalized ' 'TPR20\n']);
