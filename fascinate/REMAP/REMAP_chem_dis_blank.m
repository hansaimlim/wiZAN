...
outfile='C:\Users\Hansaim\Documents\GitHub\wiZAN\fascinate\REMAP\dis_sim\TPR20_blank.txt'
...
fid=fopen(outfile,'a+');
fprintf(fid,['rank=' num2str(rank) ' iter=' num2str(iter) ' dis_sim=blank ' 'TPR20\n']);
