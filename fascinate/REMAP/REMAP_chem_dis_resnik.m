function REMAP_chem_dis_resnik()
...
load('C:\Users\Hansaim\Documents\GitHub\wiZAN\fascinate\data\similarity\dis_dis_sim_vector_norm.mat');%load /scratch/hansaim.lim/wiZAN/fascinate/data/chem_gene/chem_gene
...
outfile='C:\Users\Hansaim\Documents\GitHub\wiZAN\fascinate\REMAP\dis_sim\TPR20_resnik.txt'
input_dir='C:\Users\Hansaim\Documents\GitHub\wiZAN\fascinate\data\chem_dis\10fold\'
chem_chem_mat=chem_chem_sim;
prot_prot_mat=dis_dis_sim_resnik_norm;
...
fid=fopen(outfile,'a+');
fprintf(fid,['rank=' num2str(rank) ' iter=' num2str(iter) ' dis_sim=resnik_normalized ' 'TPR20\n']);
