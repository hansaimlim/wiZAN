...
#            tpr_35=TPR_by_cutRank(rcrs,35)
#            tpr_100=TPR_by_cutRank(rcrs,100)
#            tpr_350=TPR_by_cutRank(rcrs,350)
#            print sarr
#            print rcrs
#            print "TPR35: %.5f, TPR100: %.5f, TPR350: %.5f" % (tpr_35,tpr_100,tpr_350)
#            print "Time: %.6f" % (time.clock()-tic)
            #new_dti_file = os.path.join(output_dir, "_".join([method, dataset, "new_dti.txt"]))
            #(predict_pairs, new_dti_file, os.path.join(data_dir, 'biodb'))
