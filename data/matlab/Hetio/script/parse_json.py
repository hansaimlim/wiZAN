...
def get_edge(jsonfile, DICTS, writeout=False):
  ...
  with open(jsonfile, "r") as inf:
    ...
    AdG=sparse.coo_matrix(([1]*len(AdG_row),(AdG_row,AdG_col)), shape=(anat_max_idx,gene_max_idx),dtype=np.int8)
    AeG=sparse.coo_matrix(([1]*len(AeG_row),(AeG_row,AeG_col)), shape=(anat_max_idx,gene_max_idx),dtype=np.int8)
    AuG=sparse.coo_matrix(([1]*len(AuG_row),(AuG_row,AuG_col)), shape=(anat_max_idx,gene_max_idx),dtype=np.int8)
    CbG=sparse.coo_matrix(([1]*len(CbG_row),(CbG_row,CbG_col)), shape=(comp_max_idx,gene_max_idx),dtype=np.int8)
    CdG=sparse.coo_matrix(([1]*len(CdG_row),(CdG_row,CdG_col)), shape=(comp_max_idx,gene_max_idx),dtype=np.int8)
    CuG=sparse.coo_matrix(([1]*len(CuG_row),(CuG_row,CuG_col)), shape=(comp_max_idx,gene_max_idx),dtype=np.int8)
    CcSE=sparse.coo_matrix(([1]*len(CcSE_row),(CcSE_row,CcSE_col)), shape=(comp_max_idx,se_max_idx),dtype=np.int8)
    CpD=sparse.coo_matrix(([1]*len(CpD_row),(CpD_row,CpD_col)), shape=(comp_max_idx,dis_max_idx),dtype=np.int8)
    CtD=sparse.coo_matrix(([1]*len(CtD_row),(CtD_row,CtD_col)), shape=(comp_max_idx,dis_max_idx),dtype=np.int8)
    DaG=sparse.coo_matrix(([1]*len(DaG_row),(DaG_row,DaG_col)), shape=(dis_max_idx,gene_max_idx),dtype=np.int8)
    DdG=sparse.coo_matrix(([1]*len(DdG_row),(DdG_row,DdG_col)), shape=(dis_max_idx,gene_max_idx),dtype=np.int8)
    DuG=sparse.coo_matrix(([1]*len(DuG_row),(DuG_row,DuG_col)), shape=(dis_max_idx,gene_max_idx),dtype=np.int8)
    DlA=sparse.coo_matrix(([1]*len(DlA_row),(DlA_row,DlA_col)), shape=(dis_max_idx,anat_max_idx),dtype=np.int8)
    DpS=sparse.coo_matrix(([1]*len(DpS_row),(DpS_row,DpS_col)), shape=(dis_max_idx,symp_max_idx),dtype=np.int8)
    DrD=sparse.coo_matrix(([1]*len(DrD_row),(DrD_row,DrD_col)), shape=(dis_max_idx,dis_max_idx),dtype=np.int8)
    GcG=sparse.coo_matrix(([1]*len(GcG_row),(GcG_row,GcG_col)), shape=(gene_max_idx,gene_max_idx),dtype=np.int8)
    GiG=sparse.coo_matrix(([1]*len(GiG_row),(GiG_row,GiG_col)), shape=(gene_max_idx,gene_max_idx),dtype=np.int8)
    GpBP=sparse.coo_matrix(([1]*len(GpBP_row),(GpBP_row,GpBP_col)), shape=(gene_max_idx,bp_max_idx),dtype=np.int8)
    GpCC=sparse.coo_matrix(([1]*len(GpCC_row),(GpCC_row,GpCC_col)), shape=(gene_max_idx,cc_max_idx),dtype=np.int8)
    GpMF=sparse.coo_matrix(([1]*len(GpMF_row),(GpMF_row,GpMF_col)), shape=(gene_max_idx,mf_max_idx),dtype=np.int8)
    GpPW=sparse.coo_matrix(([1]*len(GpPW_row),(GpPW_row,GpPW_col)), shape=(gene_max_idx,pw_max_idx),dtype=np.int8)
    GrG=sparse.coo_matrix(([1]*len(GrG_row),(GrG_row,GrG_col)), shape=(gene_max_idx,gene_max_idx),dtype=np.int8)
    PCiC=sparse.coo_matrix(([1]*len(PCiC_row),(PCiC_row,PCiC_col)), shape=(pc_max_idx,comp_max_idx),dtype=np.int8)
    if writeout:
